<%-- 
    Document   : compra_ven
    Created on : 28/11/2019, 01:16:22 PM
    Author     : Jeobany
--%>
...
<%
    ...
    ArrayList<ArrayList<String>> products = obj.getSales(id);
                ...
                <th>
                       <div class="product-card">
                        ...
                        <div class="product-details">
                                ...
                                <h4><a href="ordersven.jsp?product=<%=products.get(i).get(4)%>"><%=products.get(i).get(1)%></a></h4>
                            <div class="product-bottom-details">
                                <div class="product-price"><small>$<%=products.get(i).get(2)%></small>$<%=priceDes%></div>
            ...
            <%} else{%>
                <th>
                  ...
                  <div class="product-details">
                    ...
                    <h4><a href="ordersven.jsp?product=<%=products.get(i).get(4)%>"><%=products.get(i).get(1)%></a></h4>
                      <div class="product-bottom-details">
                        <div class="product-price"><small></small>$<%=products.get(i).get(2)%></div>
                        </div>
                       </div>
                     </div>
                </th>
