...
<%
    ...
    if(cad != null){
        ArrayList<String> result = obj.deleteProdCart(id , cad);
        response.sendRedirect("Carrito.jsp");
    }
    

    ArrayList<ArrayList<String>> products = obj.getMyCar(id);
%>
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <div class="product-details">
                            ...
                            <div class="product-bottom-details">
                                ...
                                <div class="product-links">
                                    <a href="Carrito.jsp?product=<%=products.get(i).get(5)%>"><i class="fa fa-trash-alt" aria-hidden="true"></i></a>
                                    <a href="FinalBuy.jsp?product=<%=products.get(i).get(5)%>"><i class="fas fa-credit-card"></i></a>
                                </div>
                            </div>
                        </div>
                    </div> 
