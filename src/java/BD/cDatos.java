...
public class cDatos {
    ...
    public cDatos() {
        ...
        this.usrBD = "root";
        this.passBD = "GoldZRE7!";
        //this.urlBD = "jdbc:mysql://127.0.0.1:3306/ODYSSEYMARKET_DB";
        this.urlBD = "jdbc:mysql://localhost:3306/odysseymarket_db?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    ...
    public void conectar() throws SQLException {
        try {
            ...
            System.out.println("Error cawn" + err.getMessage());
        }
    }
