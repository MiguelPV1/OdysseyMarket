<%-- 
    Document   : newjsp1
    Created on : 23/11/2019, 09:49:19 PM
    Author     : Miguel PV
--%>
...
<%
    ...
    if(goo!=null){
        String text=new String(request.getParameter("busqueda").getBytes("ISO-8859-1"),"UTF-8");
        products=obj.searchProducts(text);
    }
                       ...
                       <div class="product-card">
                        ...
                        <div class="product-details">
                            ...
                            <div class="product-bottom-details">
                                ...
                                <%if((id.equalsIgnoreCase("") || id == null) || roll.compareTo("1")==0){}else{%><a href="seProduct.jsp?del=<%=products.get(i).get(5)%>" onclick="alert('Producto agregado al carrito')"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a><%}%>
                                </div>
                            </div>
                        </div>
                    </div> 
