...
<%
    ...
    if(category!=null){
        products = obj.getProducts(category);
    }else{
                       ...
                       <div class="product-card">
                        ...
                        <div class="product-details">
                            ...
                            <div class="product-bottom-details">
                                ...
                                <%if((id.equalsIgnoreCase("") || id == null) || roll.compareTo("1")==0){}else{%><a href="products.jsp?Category=<%=category%>&del=<%=products.get(i).get(5)%>" onclick="alert('Producto agregado al carrito')"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a><%}%>
                                </div>
                            </div>
                        </div>
                    </div> 
