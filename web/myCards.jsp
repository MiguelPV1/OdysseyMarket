<%-- 
    Document   : myCards
    Created on : 26/11/2019, 12:42:43 AM
    Author     : Miguel PV
--%>
...
<%
    ...
    if(cad != null){
        ArrayList<String> result = obj.deleteCard(id, cad);
            ...
            %>
                <th>
                  ...
                  <div class="product-details">
                    <span class="product-catagory"><%=cards.get(i).get(1)%></span>
                    <h4><a><%=cards.get(i).get(2)%></a></h4>
                      <div class="product-bottom-details">
                        <div class="product-price"><%=cards.get(i).get(0)%></div>
                            <div class="product-links">
                             <a href="myCards.jsp?card=<%=cards.get(i).get(3)%>"><i class="fa fa-trash-alt" aria-hidden="true"></i></a>
                             <a href="editCard.jsp?card=<%=cards.get(i).get(3)%>"><i class="fa fa-pencil-alt" aria-hidden="true"></i></a>
                            </div>
                        </div>
                       </div>
                     </div>
        ...
        <th>
            <div class="product-card">
                ...
                <div class="product-details">
                    ...
                    <div class="product-bottom-details">
                        <div class="product-links">
                            <a href="editCard.jsp"><i class="fa fa-pencil-alt" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
            </div> 
